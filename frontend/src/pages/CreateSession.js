...
<div className="form-group">
<label>Price (Rs.) {isFreeSession && <span style={{ color: 'var(--primary-deeper)', fontSize: '12px', fontWeight: 500 }}>— Free Session</span>}</label>
<input
                ...
                style={isFreeSession ? { backgroundColor: 'var(--primary-soft)', color: '#9ca3af', cursor: 'not-allowed' } : {}}

              />

              {isFreeSession && <p style={{ fontSize: '12px', color: 'var(--primary-deeper)', marginTop: 4 }}>Type A sessions are always free</p>}
...
<input
            ...
            {/* Clock picker — doc 7 ෙකේ feature */}
<div className="form-group">
...
<button type="submit" className="btn btn-primary btn-block" disabled={loading}>
      ...
      {/* TimePickerModal — doc 7 ෙකේ feature */}
